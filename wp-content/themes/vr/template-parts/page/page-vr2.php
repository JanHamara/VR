...
<div id="top2" class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <!--    Video Switch    -->
            <a href="https://www.youtube.com/watch?v=D61flqml22o" class="modal-switch" aria-label="Video Content Switch" target="_blank">
                <i aria-hidden="true" class="fa fa-video video-content-icon" title="Video Content Icon"></i>
            </a>

            <!--    Text-to-Speech Switch    -->
            <a id="vo-history" href="#" class="modal-switch" aria-label="Text-To-Speech Switch">
